  ...
  render() {
    return (
      <div className="container">
        ...
        {this.state.existingNetworks.length > 0 ? (<NetworkDeviceCellScreenTemplate dataJson={this.state.existingNetworks} withLinks={false} type="chooseNetwork"></NetworkDeviceCellScreenTemplate>) : (<p>No existing networks were found.</p>)}
