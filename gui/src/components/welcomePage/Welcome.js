    ...
    return (
      <div className="container" id="welcomeContent">
        ...
        <div className="accountInfo">
          ...
          <div>
            <Link className="link" to="/networkConfigsMain" id="networkConfigsMainLink">View Network Configs</Link>
            <br></br>
            <Link className="link" to="/deviceConfigsMain" id="deviceConfigsMainLink">View IoT Device Configs</Link>
            <br></br>
